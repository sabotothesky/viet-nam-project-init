...
import { 
  Trophy, X, Percent, Calendar, History, Search, Loader2, ChevronRight 
} from 'lucide-react';
      ...
      if (matchesData && matchesData.length > 0) {
        ...
        if (filters.opponent) {
          filteredData = filteredData.filter(match => {
            ...
            return opponent?.full_name?.toLowerCase().includes(filters.opponent.toLowerCase());
          });
        }
        ...
        const wins = filteredData.filter(match => match.winner_id === user.id).length;
    ...
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-gray-600">Vui lòng đăng nhập để xem lịch sử trận đấu</p>
        </div>
      </div>
    );
  }
          ...
          <CardContent className="pt-6">
            <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
              ...
              <div className="flex items-end">
                <Button onClick={fetchMatchHistory} className="w-full flex items-center gap-2">
        ...
        <Card>
          {loading ? (
            ...
            <CardContent className="text-center py-12">
              ...
              <p className="text-gray-600">Tham gia thách đấu hoặc giải đấu để xem lịch sử ở đây</p>
            </CardContent>
          ) : (
              ...
              {matches.map((match) => {
                ...
                return (
                  <div key={match.id} className="p-6 hover:bg-gray-50">
                    <div className="flex items-center justify-between">
                      <div className="flex items-center space-x-4">
                        ...
                        <div className="flex items-center space-x-3">
                          ...
                          <div>
                            <p className="font-medium text-gray-900">{opponent?.full_name || 'Unknown'}</p>
                      ...
                      <div className="flex items-center space-x-4">
                        <div className="text-right">
                          ...
                          <p className="text-xs text-gray-500">
                            {match.match_statistics?.[0]?.match_duration_minutes || 0} phút
                          </p>
                        </div>
                    ...
                    {/* Match Statistics */}
                    {match.match_statistics && match.match_statistics.length > 0 && (
                      <div className="mt-4 pt-4 border-t border-gray-100">
                        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-sm">
                          <div className="text-center">
                            <p className="font-medium text-gray-900">
                              {match.match_statistics[0]?.successful_shots || 0}/{match.match_statistics[0]?.total_shots || 0}
                            </p>
                          ...
                          <div className="text-center">
                            <p className="font-medium text-gray-900">
                              {match.match_statistics[0]?.fouls_committed || 0}
                            </p>
