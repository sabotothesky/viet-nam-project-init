      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {stats.map((stat, index) => (
            ...
            >
              {/* Icon with gradient */}
              <div className={`w-14 h-14 rounded-xl bg-gradient-to-r ${stat.gradient} p-0.5 mb-6 group-hover:scale-110 transition-transform duration-300 pocket-shadow`}>
              ...
              <div className="mb-2">
                ...
                <span className={`ml-2 text-sm font-bold px-2 py-1 rounded-full bg-gradient-to-r ${stat.gradient} text-black`}>
                  {stat.change}
                </span>
              </div>
        ...
        <div className="mt-16 text-center">
          <div className="inline-flex items-center gap-3 px-6 py-3 card-billiards rounded-full border border-yellow-400/30">
            ...
            <span className="text-yellow-400 font-semibold text-sm">DỮ LIỆU TRỰC TIẾP • CẬP NHẬT MỖI 30 GIÂY</span>
            <div className="w-2 h-2 bg-yellow-400 rounded-full animate-pulse"></div>
          </div>
        </div>
      </div>
