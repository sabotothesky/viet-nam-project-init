...
const AdminTournaments = () => {
  const { tournaments, isLoading, createTournament, generateBracket } = useTournaments();
    ...
    <AdminLayout>
      <div className="space-y-6">
        ...
        <div className="flex justify-between items-center">
          <div>
            <h1 className="text-3xl font-bold text-gray-900">Quản Lý Giải Đấu</h1>
        ...
        {filteredTournaments.length === 0 && (
          <div className="text-center py-12">
            ...
            <p className="text-gray-500 font-medium">Không tìm thấy giải đấu nào</p>
            <p className="text-gray-400 text-sm mt-2">Thử thay đổi bộ lọc hoặc tạo giải đấu mới</p>
          </div>
        )}
      </div>
    </AdminLayout>
