...
interface NotificationCardProps {
  ...
  onRespond?: (challengeId: string, status: 'accepted' | 'declined', proposalData?: Record<string, any>) => void;
}

const EnhancedNotificationCard = ({ notification, onMarkAsRead, onRespond }: NotificationCardProps) => {
  ...
  const handleRespond = (status: 'accepted' | 'declined', proposalData?: Record<string, any>) => {
              ...
              {notification.challenge ? (
                <UserAvatar 
                  user={{
                    ...
                    avatar: notification.challenge.challenger.avatar_url || '/placeholder.svg',
              ...
              {notification.challenge && (
                <div className="bg-gray-50 rounded-lg p-3 mb-3">
                  <div className="flex justify-between items-center text-sm">
                    ...
                    <span className="font-bold text-blue-600">{notification.challenge.bet_points} điểm</span>
                  </div>
