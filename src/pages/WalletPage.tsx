...
const WalletPage: React.FC = () => {
  ...
  const handleTransferSuccess = (recipientId: string, amount: number, message: string) => {
    console.log('Transfer successful:', { recipientId, amount, message });
    // Refresh wallet data
    ...
    return (
      <div className="flex items-center justify-center min-h-screen">
        <div className="text-center">
          <h2 className="text-2xl font-bold text-gray-900 mb-2">Không thể tải dữ liệu ví</h2>
          ...
          <TabsContent value="analytics" className="space-y-6">
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                ...
                <CardContent>
                  <div className="space-y-3">
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <span className="font-medium text-blue-600">+170,000 VNĐ</span>
                    </div>
                  </div>
                </CardContent>
              </Card>
              ...
              <Card>
                ...
                <CardContent>
                  <div className="text-center">
                    ...
                    <div className="text-sm text-gray-600">24/35 trận thắng</div>
              ...
              <Card>
                ...
                <CardContent>
                  <div className="text-center">
                    <div className="text-3xl font-bold text-blue-600 mb-2">18,750 VNĐ</div>
