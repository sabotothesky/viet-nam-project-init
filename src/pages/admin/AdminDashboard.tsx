  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <Card>
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            <CardTitle className="text-sm font-medium">Thành viên Premium</CardTitle>
          ...
          <CardContent>
            <div className="space-y-4">
              <div className="flex items-center gap-3">
                ...
                <span className="text-sm">User mới: Nguyễn Văn A đã đăng ký</span>
              </div>
              <div className="flex items-center gap-3">
          ...
          <CardContent>
            <div className="space-y-4">
              <div className="flex justify-between">
                <span className="text-sm text-gray-600">Tỷ lệ Premium/Free</span>
                <span className="text-sm font-medium">
                  {stats?.totalUsers ? Math.round((stats.activeMembers / stats.totalUsers) * 100) : 0}%
                </span>
              </div>
              <div className="flex justify-between">
                <span className="text-sm text-gray-600">Doanh thu trung bình/user</span>
                <span className="text-sm font-medium">
                  {stats?.totalUsers ? Math.round((stats?.totalRevenue || 0) / stats.totalUsers).toLocaleString('vi-VN') : 0}đ
                </span>
              </div>
              <div className="flex justify-between">
                <span className="text-sm text-gray-600">Giải đấu hoạt động</span>
                <span className="text-sm font-medium">{stats?.activeTournaments || 0}</span>
              </div>
            </div>
          </CardContent>
        </Card>
