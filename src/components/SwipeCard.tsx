    ...
    >
      <div className="w-full h-full bg-white rounded-2xl shadow-2xl overflow-hidden">
        ...
        <div className="h-3/4 relative">
          ...
          <div className="absolute bottom-4 left-4 right-4 text-white">
            <div className="flex items-end justify-between">
              <div>
                <h2 className="text-3xl font-bold">{opponent.name}, {opponent.age}</h2>
                <div className="flex items-center space-x-2 mt-2">
                  <div className="bg-yellow-500 px-3 py-1 rounded-full">
                    <span className="text-sm font-bold text-black">{opponent.ranking}</span>
                  </div>
                  <span className="text-sm opacity-90">{opponent.location}</span>
                </div>
                <p className="text-sm opacity-80 mt-2 line-clamp-2">{opponent.bio}</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="h-1/4 p-4 flex justify-between items-center bg-white">
          ...
          <div className="text-center">
            <div className="text-lg font-bold text-blue-600">{opponent.winRate}%</div>
            <div className="text-xs text-gray-500">Tỷ lệ thắng</div>
          </div>
          <div className="text-center">
            <div className="text-lg font-bold text-purple-600">{opponent.recentAchievements.length}</div>
