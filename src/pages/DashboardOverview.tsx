...
import { Trophy, Target, Users, TrendingUp, Calendar, Bell } from 'lucide-react';
...
const DashboardOverview = () => {
  ...
  const quickActions = [
    { icon: Trophy, label: 'Xem Ranking', color: 'bg-blue-600', route: '/ranking' },
    { icon: Calendar, label: 'Giải đấu', color: 'bg-green-600', route: '/tournaments' },
    { icon: Users, label: 'Thách đấu', color: 'bg-purple-600', route: '/challenges' },
    { icon: Target, label: 'Cập nhật hồ sơ', color: 'bg-orange-600', route: '/profile' },
  ];
        ...
        <CardContent>
          <div className="space-y-4">
            ...
            <div className="flex items-center space-x-4 p-3 bg-gray-50 rounded-lg">
              ...
              <div className="flex-1">
                <p className="text-sm font-medium">Tham gia hệ thống SABO POOL</p>
