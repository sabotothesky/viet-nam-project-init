...
const CreateTournamentPage = () => {
  ...
  const ranks = ['K1', 'K2', 'K3', 'K4', 'K5', 'A1', 'A2', 'A3', 'A4', 'A5', 'B1', 'B2', 'B3', 'B4', 'B5', 'G1', 'G2', 'G3', 'G4', 'G+'];
    ...
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="text-center">
          ...
          <h2 className="text-xl font-semibold text-gray-900 mb-2">Cần xác minh CLB</h2>
          <p className="text-gray-600 mb-4">Chỉ các CLB đã xác minh mới có thể tạo giải đấu</p>
    ...
    <div className="min-h-screen bg-gray-50">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <Card>
          ...
          <CardContent>
            <form onSubmit={handleSubmit(handleCreateTournament)} className="space-y-6">
              {/* Basic Info */}
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="md:col-span-2">
                  ...
                  <Input
                    id="name"
                    {...register('name', { required: 'Vui lòng nhập tên giải đấu' })}
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                  ...
                  <Input
                    id="end_time"
                    type="time"
                    {...register('end_time', { required: 'Vui lòng chọn giờ kết thúc' })}
                  />
                ...
                <div>
                  ...
                  <Input
                    ...
                    type="date"
                    {...register('registration_deadline', { required: 'Vui lòng chọn hạn đăng ký' })}
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                  ...
                  <Select onValueChange={(value) => setValue('max_participants', value)}>
                    <SelectTrigger>
                  ...
                  {errors.max_participants && <p className="mt-1 text-sm text-red-600">{errors.max_participants.message}</p>}
                </div>

                <div>
                  <Label htmlFor="bracket_type">Thể thức thi đấu</Label>
                  <Select onValueChange={(value) => setValue('bracket_type', value)} defaultValue="single_elimination">
                    <SelectTrigger>
                      <SelectValue />
                    </SelectTrigger>
                    <SelectContent>
              ...
              <div>
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-3 mt-2">
                  {ranks.map((rank) => (
                    <div key={rank} className="flex items-center space-x-2">
                      <Checkbox
                        id={rank}
                        {...register('eligible_ranks', { required: 'Vui lòng chọn ít nhất một hạng' })}
                        value={rank}
                      />
                ...
                {errors.eligible_ranks && <p className="mt-1 text-sm text-red-600">{errors.eligible_ranks.message}</p>}
              </div>
