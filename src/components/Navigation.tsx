...
import { Menu, X, Trophy, Target, Users, Circle, User, Settings, Wallet, HelpCircle, LogOut, LayoutDashboard, Crown, History } from 'lucide-react';
...
const Navigation = () => {
  ...
  const navigationItems = [
    ...
    { name: 'Giải đấu', href: '/tournaments', current: location.pathname === '/tournaments' },
    { name: 'Ranking', href: '/leaderboard', current: location.pathname === '/leaderboard' },
    { name: 'CLB', href: '/clubs', current: location.pathname === '/clubs' },
    { name: 'Thách đấu', href: '/challenges', current: location.pathname === '/challenges' },
          ...
          <div className="flex items-center">
            <Link to="/" className="flex items-center space-x-3">
              ...
              <div className="hidden sm:flex flex-col">
                ...
                <span className="text-sm text-yellow-600 font-bold -mt-1">POOL ARENA</span>
              </div>
            </Link>
          </div>
