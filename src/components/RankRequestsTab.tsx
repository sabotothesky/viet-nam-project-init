          ...
          <DialogContent>
            ...
            <div className="space-y-4">
              <p className="text-sm text-gray-600">
                Người dùng sẽ được thông báo đến CLB để kiểm tra trước khi xác nhận rank.
              </p>
                      ...
                      <div className="flex-1 space-y-2">
                        <div className="flex items-center space-x-2">
                          <h3 className="font-medium">
                            {request.user?.profiles?.nickname || request.user?.profiles?.full_name || request.user?.email}
                          </h3>
                        ...
                        {request.approved_by && (
                          <div className="text-sm text-green-600">
                            <strong>Phê duyệt bởi:</strong> {request.approver?.profiles?.nickname || request.approver?.email}
                          </div>
                        )}
                      </div>
                    </div>
