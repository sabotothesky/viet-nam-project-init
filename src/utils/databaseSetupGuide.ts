...
export const getSetupRecommendation = (hasExistingData: boolean, isAccessible: boolean): string => {
  if (!isAccessible) {
    return "createNew";
  }
...
export const generateEnvironmentTemplate = (projectId: string, apiKey: string): string => {
