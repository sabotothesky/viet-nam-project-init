    ...
    try {
      ...
      setTournaments([
        ...
        },
        {
          ...
          description: 'Giải đấu cấp quốc gia dành cho các tay chơi chuyên nghiệp',
              ...
              <CardContent className="space-y-4">
                ...
                <div className="flex items-center gap-2">
                  <Avatar className="h-6 w-6">
                    ...
                    <AvatarFallback>{tournament.organizer.username[0]}</AvatarFallback>
                  </Avatar>
                  <span className="text-sm text-gray-600">{tournament.organizer.username}</span>
                </div>
                ...
                <div className="space-y-2">
                  <div className="flex items-center gap-2 text-sm">
                    ...
                    <span>{tournament.start_date.toLocaleDateString('vi-VN')} - {tournament.end_date.toLocaleDateString('vi-VN')}</span>
                  </div>
                  ...
                  <div className="flex items-center gap-2 text-sm">
                    ...
                    <span>{tournament.current_participants}/{tournament.max_participants} người tham gia</span>
                  </div>
                </div>
