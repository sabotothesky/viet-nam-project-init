...
import { 
  MapPin, Phone, Mail, Users, DollarSign, Table, Star, 
  Calendar, Info, Trophy, UserPlus, Heart, Share2, 
  Eye, Target, Loader2, Building
} from 'lucide-react';
import TableBookingForm from '@/components/TableBookingForm';
import { Club, ClubFacilities } from '@/types/common';
    ...
    return (
      <div className="min-h-screen flex items-center justify-center">
        <div className="text-center">
          ...
          <h2 className="text-xl font-semibold text-gray-900 mb-2">Không tìm thấy câu lạc bộ</h2>
          <p className="text-gray-600 mb-4">Câu lạc bộ này có thể đã bị xóa hoặc không tồn tại</p>
        ...
        <Card className="mb-6 overflow-hidden">
          ...
          <CardContent className="p-6 border-b">
            <div className="flex flex-wrap gap-3">
              ...
              <Button onClick={handleJoinClub} variant="secondary" className="flex items-center">
                    ...
                    {tournaments.length > 0 ? (
                      <div className="space-y-3">
                        {tournaments.slice(0, 3).map((tournament) => (
                          <div key={tournament.id} className="flex items-center justify-between p-3 bg-gray-50 rounded-md">
                            <div>
                              ...
                              <div className="flex-1">
                                ...
                                <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-sm text-gray-600">
                                  ...
                                  <div className="flex items-center">
                                    ...
                                    {tournament.entry_fee?.toLocaleString('vi-VN') || 'Miễn phí'}
                                  </div>
                                  <div className="flex items-center">
                                    <Trophy className="w-4 h-4 mr-1" />
                                    {tournament.prize_pool?.toLocaleString('vi-VN') || 'Chưa có'} VNĐ
                                  </div>
                                </div>
                ...
                {club.phone && (
                  <div className="flex items-center">
                    ...
                    <div>
                      ...
                      <a href={`tel:${club.phone}`} className="text-sm text-blue-600 hover:text-blue-800">
                        {club.phone}
                      </a>
                    </div>
                  </div>
                ...
                {club.email && (
                  <div className="flex items-center">
                    ...
                    <div>
                      ...
                      <a href={`mailto:${club.email}`} className="text-sm text-blue-600 hover:text-blue-800">
                        {club.email}
                      </a>
                    </div>
                  </div>
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <span className="text-sm font-medium text-gray-900">{club.table_count || 0}</span>
                </div>
                <div className="flex items-center justify-between">
                    ...
                    <div key={member.user_id} className="flex items-center space-x-3">
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <p className="text-xs text-gray-500">
                          {member.current_rank || 'K1'} • {member.ranking_points || 0} điểm
                        </p>
                      </div>
                    </div>
                  ))}
