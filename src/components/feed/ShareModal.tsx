...
export const ShareModal: React.FC<ShareModalProps> = ({
  ...
  const [selectedType, setSelectedType] = useState<'public' | 'friends'>('public');
  ...
  const handleEmail = () => {
    ...
    window.open(`mailto:?subject=Check out this post&body=${encodeURIComponent(window.location.href)}`);
    onClose();
  };
    ...
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="max-w-md">
        ...
        <div className="space-y-6">
          ...
          <div className="space-y-3">
            ...
            <div className="space-y-2">
              {shareOptions.map((option) => (
                <button
                  key={option.id}
                  onClick={() => setSelectedType(option.id as 'public' | 'friends')}
          ...
          <div className="space-y-3">
            <h3 className="font-medium text-gray-900">Chia sẻ trên mạng xã hội</h3>
            ...
            <div className="space-y-2">
              ...
              >
                ...
                <div className="text-left">
                  ...
                  <div className="text-sm text-gray-600">
                    {copied ? 'Liên kết đã được sao chép' : 'Chia sẻ liên kết trực tiếp'}
                  </div>
                </div>
              </button>
              ...
              >
                ...
                <div className="text-left">
                  ...
                  <div className="text-sm text-gray-600">Gửi cho bạn bè cụ thể</div>
                </div>
              </button>
