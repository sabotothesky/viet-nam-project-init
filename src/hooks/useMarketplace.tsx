...
export const useMarketplace = (userId?: string) => {
        ...
        const mockItems: MarketplaceItem[] = [
          {
            ...
            description:
              'Cơ bida Predator Ikon4-3, chất lượng cao, phù hợp cho người chơi chuyên nghiệp. Đã sử dụng 6 tháng, còn rất tốt.',
            category: 'equipment',
            subcategory: 'cues',
            condition: 'good',
            price: 2500000,
          ...
          },
          {
            ...
            description:
              'Bộ phấn bida Master Chalk, 12 viên, màu xanh. Chất lượng cao, độ bám tốt.',
          ...
          },
          {
            ...
            description:
              'Sách "Nghệ thuật chơi bida" - hướng dẫn từ cơ bản đến nâng cao. Sách mới, chưa sử dụng.',
            category: 'books',
          ...
          },
          {
            ...
            description:
              'Áo thun bida chất liệu cotton cao cấp, thiết kế thoải mái. Size L, màu đen.',
            category: 'clothing',
            subcategory: 'shirts',
            condition: 'like_new',
            price: 180000,
  ...
  const updateItem = useCallback(
    async (itemId: string, data: Partial<MarketplaceItem>) => {
      try {
        setItems(prev =>
          prev.map(item =>
            item.id === itemId
  ...
  const getFilteredItems = useCallback(() => {
    ...
    if (filters.shipping_available !== undefined) {
      filtered = filtered.filter(
        item => item.shipping.available === filters.shipping_available
      );
    }
