...
export const SecuritySettings: React.FC<SecuritySettingsProps> = ({
  ...
  const getSecurityLevel = (score: number) => {
    if (score >= 80) return { level: 'Cao', color: 'bg-green-100 text-green-800' };
    if (score >= 60) return { level: 'Trung bình', color: 'bg-yellow-100 text-yellow-800' };
        ...
        <CardContent>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div className="text-center">
              ...
              <div className="text-sm text-gray-600">Thiết bị đang hoạt động</div>
            </div>
          </div>
        </CardContent>
      </Card>
          ...
          {settings.twoFactorEnabled && (
            <div className="p-4 bg-blue-50 rounded-lg">
              ...
              <p className="text-sm text-blue-700">
                Tài khoản của bạn được bảo vệ bằng mã xác thực từ ứng dụng hoặc SMS.
              </p>
            </div>
          )}
        </CardContent>
        ...
        <CardContent className="space-y-4">
          <div className="flex items-center justify-between">
            <div>
              ...
              <div className="text-sm text-gray-600">
                Tự động đăng xuất sau {settings.sessionTimeout} phút không hoạt động
              </div>
            </div>
            <Input
              type="number"
            ...
            <div className="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <div className="text-sm text-gray-600">Hà Nội, VN • Đang hoạt động</div>
                </div>
              </div>
            ...
            <div className="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <div className="text-sm text-gray-600">TP.HCM, VN • 2 giờ trước</div>
                </div>
              </div>
            ...
            <div className="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <div className="text-sm text-gray-600">Đà Nẵng, VN • 1 ngày trước</div>
                </div>
              </div>
              <Button variant="outline" size="sm">
                Đăng xuất
