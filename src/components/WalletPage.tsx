...
const WalletPage = () => {
  ...
  const getTransactionIcon = (type: string) => {
    switch (type) {
      ...
      case 'refund': return <RotateCcw className="w-5 h-5 text-purple-600" />;
          ...
          <CardContent className="p-6">
            <div className="flex items-center justify-between">
              ...
              <div className="text-right">
                ...
                <p className="text-blue-100 text-sm">ID: {wallet?.id?.slice(-8)}</p>
              </div>
            </div>
                  ...
                  <div key={transaction.id} className="py-4 flex items-center justify-between">
                    ...
                    <div className="text-right">
                      ...
                      <p className="text-xs text-gray-500">
                        Số dư: {transaction.balance_after.toLocaleString('vi-VN')} VNĐ
                      </p>
