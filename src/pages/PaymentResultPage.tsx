    ...
    switch (status) {
      case 'success':
        return {
          ...
          message: 'Tài khoản của bạn đã được nâng cấp lên Premium. Bạn có thể sử dụng tất cả tính năng cao cấp ngay bây giờ.',
      ...
      case 'failed':
        return {
          ...
          message: 'Giao dịch không thể hoàn tất. Vui lòng thử lại hoặc liên hệ hỗ trợ nếu vấn đề tiếp tục xảy ra.',
          color: 'text-red-600'
        };
      default:
        return {
          ...
          title: 'Có lỗi xảy ra',
          message: 'Không thể xác định trạng thái thanh toán. Vui lòng kiểm tra lại trong tài khoản của bạn.',
