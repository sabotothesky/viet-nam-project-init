      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <div className="mb-8">
          <div className="inline-flex items-center gap-4 mb-6">
            ...
            <div className="text-left">
              ...
              <p className="text-xl text-yellow-400 font-bold -mt-2">POOL ARENA</p>
            </div>
          </div>
        </div>
        ...
        <div className="mb-12">
          <h2 className="text-4xl md:text-6xl lg:text-7xl font-black text-white mb-6 leading-tight">
            <span className="white-glow">ĐẤNG CAO THỦ</span><br />
          ...
          <p className="text-xl md:text-2xl text-gray-200 max-w-4xl mx-auto mb-8 leading-relaxed">
            Nền tảng thi đấu bida chuyên nghiệp với hệ thống ranking ELO, 
            giải đấu hàng tuần và cộng đồng game thủ hàng đầu Việt Nam
          </p>
        </div>
        ...
        <div className="flex flex-col sm:flex-row gap-6 justify-center items-center mb-16">
          ...
          <Link to="/tournaments">
            <Button variant="outline" className="text-lg px-8 py-4 h-auto font-bold border-2 border-yellow-400/50 text-yellow-400 hover:bg-yellow-400/10 hover:border-yellow-400 transition-all duration-300">
        ...
        <div className="flex flex-wrap justify-center gap-4">
          {[
            ...
            <div key={index} className="px-4 py-2 bg-gradient-to-r from-green-800/40 to-green-600/40 rounded-full border border-yellow-400/30 backdrop-blur-sm">
