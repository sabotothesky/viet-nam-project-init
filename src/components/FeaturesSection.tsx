  ...
  const features = [
    {
      ...
      description: "Hệ thống ELO tiên tiến theo dõi kỹ năng của bạn qua các chế độ chơi và giải đấu khác nhau.",
    ...
    },
    {
      ...
      description: "Lập đội và tham gia giải đấu theo nhóm. Giao tiếp và chiến thuật là chìa khóa chiến thắng.",
    ...
    },
    {
      ...
      description: "Thử thách hàng ngày và mini-game rèn luyện độ chính xác và kỹ thuật của bạn.",
    ...
    },
    {
      ...
      description: "Xem trận đấu chuyên nghiệp trực tiếp, học hỏi từ cao thủ và stream gameplay của chính bạn.",
    ...
    },
    {
      ...
      description: "Giám sát tiên tiến đảm bảo công bằng. Trọng tài và công nghệ của chúng tôi bảo đảm tính cạnh tranh.",
    ...
    },
    {
      ...
      description: "Kiếm skin độc quyền, nâng cấp cơ và giải thưởng tiền mặt thật. Thành viên Premium nhận thưởng cao hơn.",
      gradient: "from-yellow-400 to-yellow-600",
      glowColor: "shadow-yellow-400/20"
    }
  ];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="text-center mb-20">
          <div className="inline-flex items-center gap-2 px-4 py-2 bg-gradient-to-r from-green-800/40 to-green-600/40 rounded-full border border-yellow-400/30 mb-6 backdrop-blur-sm">
            ...
            <span className="text-sm font-semibold text-yellow-400">TÍNH NĂNG NỔI BẬT</span>
          </div>
          
          <h2 className="text-4xl md:text-6xl font-black text-white mb-6">
            <span className="white-glow">TRẢI NGHIỆM</span><br />
          ...
          <p className="text-xl text-gray-200 max-w-3xl mx-auto">
            Được xây dựng cho những người chơi nghiêm túc. Mọi tính năng được thiết kế để nâng tầm trò chơi của bạn.
          </p>
        </div>
        ...
        <div className="text-center mt-16">
          <div className="inline-flex items-center gap-4">
            ...
            <span className="text-yellow-400 font-bold text-lg gold-glow">THAM GIA CUỘC THI</span>
            <div className="h-px bg-gradient-to-r from-transparent via-yellow-400 to-transparent w-20"></div>
          </div>
        </div>
      </div>
