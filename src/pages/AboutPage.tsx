  ...
  const team = [
    {
      ...
      avatar: 'https://api.dicebear.com/7.x/adventurer/svg?seed=founder&backgroundColor=b6e3f4'
    },
    {
      name: 'Trần Thị B',
      role: 'CTO',
      bio: 'Kỹ sư phần mềm hàng đầu',
      avatar: 'https://api.dicebear.com/7.x/adventurer/svg?seed=cto&backgroundColor=c0aede'
    },
    {
      name: 'Lê Văn C',
      role: 'Head of Operations',
      bio: 'Quản lý vận hành chuyên nghiệp',
      avatar: 'https://api.dicebear.com/7.x/adventurer/svg?seed=operations&backgroundColor=fecaca'
    }
  ];
            ...
            <div className="grid md:grid-cols-2 gap-12">
              <div>
                ...
                <p className="text-lg text-gray-700 leading-relaxed">
                  Tạo ra một nền tảng thi đấu bida chuyên nghiệp, công bằng và minh bạch, 
                  nơi mọi người có thể thể hiện tài năng, kết nối cộng đồng và phát triển 
                  kỹ năng bida của mình.
                </p>
              </div>
              <div>
                <h2 className="text-3xl font-bold text-gray-900 mb-6">Tầm Nhìn</h2>
                <p className="text-lg text-gray-700 leading-relaxed">
                  Trở thành nền tảng bida số 1 Việt Nam, kết nối hàng triệu người chơi 
                  bida trên toàn quốc và đưa môn thể thao này lên một tầm cao mới.
                </p>
              </div>
            </div>
          </div>
