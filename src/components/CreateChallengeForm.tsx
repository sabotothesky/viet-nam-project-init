        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="space-y-2">
            ...
            <Select
              ...
              onValueChange={(value) => setFormData(prev => ({ ...prev, opponent_id: value }))}
            >
              <SelectTrigger>
              ...
              {CHALLENGE_CONFIGS.map((config) => (
                <div
                  ...
                  className={`p-3 rounded-lg border-2 cursor-pointer transition-all ${
                    formData.bet_points >= config.bet_range.min && formData.bet_points <= config.bet_range.max
                ...
                >
                  <div className="text-center">
                    ...
                    <div className="text-sm font-medium mt-1">Race to {config.race_to}</div>
            ...
            <div className="bg-gradient-to-r from-blue-50 to-indigo-50 p-4 rounded-lg">
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-sm">
                <div>
                  ...
                  <div className="text-blue-600 font-bold">{formData.bet_points}</div>
                </div>
                <div>
                  <div className="text-blue-700 font-medium">Race to:</div>
                  <div className="text-blue-600 font-bold">{currentConfig.race_to}</div>
                </div>
                <div>
                  <div className="text-blue-700 font-medium">Chấp 1 hạng:</div>
                  <div className="text-blue-600 font-bold">{currentConfig.handicap_1_rank}</div>
                </div>
                <div>
                  <div className="text-blue-700 font-medium">Chấp 0.5 hạng:</div>
                  <div className="text-blue-600 font-bold">{currentConfig.handicap_05_rank}</div>
                </div>
              </div>
