...
const ranks = ['K3', 'K2', 'K1', 'H3', 'H2', 'H1', 'A3', 'A2', 'A1', 'B3', 'B2', 'B1', 'G3', 'G2', 'G1', 'G+'];

const DiscoveryFilters = ({ isOpen, onClose, filters, onFiltersChange }: DiscoveryFiltersProps) => {
          ...
          <CardContent className="space-y-6">
            ...
            <div>
              ...
              <div className="grid grid-cols-4 gap-2">
                {ranks.map(rank => (
                  <Button
                    key={rank}
                    variant={filters.rankRange.includes(rank) ? "default" : "outline"}
                    size="sm"
            ...
            <div>
              <Label className="text-base font-semibold flex items-center space-x-2 mb-3">
                ...
                <span>Mức cược: {filters.minBetPoints} - {filters.maxBetPoints} điểm</span>
              </Label>
              <div className="space-y-3">
                <div>
                  ...
                  <Slider
                    ...
                    onValueChange={(value) => onFiltersChange({ ...filters, minBetPoints: value[0] })}
                    max={500}
                    min={10}
                    step={10}
                ...
                <div>
                  ...
                  <Slider
                    ...
                    onValueChange={(value) => onFiltersChange({ ...filters, maxBetPoints: value[0] })}
                    max={1000}
                    min={50}
                    step={25}
                    className="w-full mt-1"
