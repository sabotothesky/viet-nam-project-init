...
export const ChallengeVerificationModal: React.FC<ChallengeVerificationModalProps> = ({
  ...
  const [verificationType, setVerificationType] = useState<'image' | 'receipt' | 'other'>('image');
          ...
          <div className="bg-gray-50 p-4 rounded-lg">
            ...
            <div className="grid grid-cols-2 gap-4 text-sm">
              <div>
                ...
                <div className="font-medium">{challenge.challenger?.full_name}</div>
              </div>
              <div>
                <span className="text-gray-600">Đối thủ:</span>
                <div className="font-medium">{challenge.opponent?.full_name}</div>
              </div>
              <div>
