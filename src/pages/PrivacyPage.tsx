          ...
          <div className="space-y-6">
            <Card>
              ...
              <CardContent className="space-y-4">
                ...
                <div className="space-y-3">
                  ...
                  <div>
                    <h4 className="font-semibold text-gray-800">Thông tin sử dụng:</h4>
                    <ul className="list-disc list-inside space-y-1 text-gray-700 ml-4">
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                ...
                <div className="space-y-3">
                  <div>
                    <h4 className="font-semibold text-gray-800">Với sự đồng ý của bạn:</h4>
                    <p className="text-gray-700">Chia sẻ thông tin với bên thứ ba khi bạn cho phép</p>
                  </div>
                  <div>
                  ...
                  <div>
                    ...
                    <p className="text-gray-700">Khi có yêu cầu từ cơ quan chức năng</p>
                  </div>
                </div>
              </CardContent>
            </Card>
            ...
            <Card>
              ...
              <CardContent>
                <p className="text-gray-700">
                  ...
                  Những thay đổi quan trọng sẽ được thông báo qua email hoặc thông báo trên ứng dụng. 
