...
const RegisterForm = () => {
  ...
  const onSubmit = async (data: RegisterFormValues) => {
    ...
    try {
      ...
      const { error } = await signUp(data.email, data.password, data.fullName, data.phone, data.clubId);
      ...
      if (error) {
        ...
        toast({
          ...
          description: "Vui lòng kiểm tra email để xác thực tài khoản. Kiểm tra cả thư mục spam nếu không thấy email.",
        });
